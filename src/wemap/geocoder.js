...
export default class WeGeocoder {
    ...
    initEvent(){
        ...
        this.geocoder.getFeatureFromResultByLatLon = this.getFeatureFromResultByLatLon
        this.geocoder._addAndGetCustomHtmlMarker = this.overrideAddAndGetCustomHtmlMarker
